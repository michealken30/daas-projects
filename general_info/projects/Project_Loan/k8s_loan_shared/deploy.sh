...
kubectl wait --for=condition=ready pod -l app=otel-collector --timeout=600s
...
kubectl wait --for=condition=available deployment/government-api --timeout=600s
...
kubectl wait --for=condition=available deployment/loan-validator-portal --timeout=600s
